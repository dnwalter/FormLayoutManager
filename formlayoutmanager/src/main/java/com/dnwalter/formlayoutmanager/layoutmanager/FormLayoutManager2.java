 ...
 * @date 2019/10/14
 */
public class FormLayoutManager2 extends RecyclerView.LayoutManager {
    ...
    public FormLayoutManager2(int columnCount){
        mColumnCount = columnCount;
    }

    public FormLayoutManager2(boolean isHorV, int count){
     ...
     */
    public FormLayoutManager2(int columnCount, RecyclerView recyclerView){
        this(true, columnCount, recyclerView);
    }

    public FormLayoutManager2(boolean isHorV, int count, RecyclerView recyclerView){
        mIsHorV = isHorV;
        if (isHorV){
            mColumnCount = count;
        }else{
